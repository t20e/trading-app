    ...
    return (
        <div id='loginCont'>
            <form onSubmit={loginUser}>
                <input type="text" className='currInput' placeholder='email' name='email' autoFocus onChange={(e) => setEmail(e.target.value)} />
                <input type="password" className='currInput' name="password" placeholder='password' onChange={(e) => setPassword(e.target.value)} />
